...
// Página de configurações da conta com direitos LGPD
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
        ...
        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg mb-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 mt-1 mb-3">
              ...
              Inclui perfil, leads criados, tarefas e atividades.
            </p>
            <button
        ...
        <div className="flex items-start gap-4 p-4 bg-red-50 rounded-lg border border-red-100">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-red-700 mt-1 mb-3">
              ...
              Os dados da organização (leads, projetos, etc.) serão mantidos
              desvinculados da sua identidade.
            </p>
      ...
      <div className="text-center text-xs text-gray-500 space-x-4">
        <a href="/privacy" target="_blank" className="hover:underline text-indigo-600">
          Política de Privacidade
        </a>
        <span>·</span>
        <a href="/terms" target="_blank" className="hover:underline text-indigo-600">
          Termos de Uso
        </a>
      </div>
    </div>
